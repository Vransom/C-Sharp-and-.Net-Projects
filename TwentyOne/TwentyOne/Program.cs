...
namespace TwentyOne
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine("Welcome to the {0} Please tell me your name:", casinoName);
            ...
            if (answer == "yes" || answer == "yeah" || answer == "y" || answer == "ya")
            {
                ...
                using (StreamWriter file = new StreamWriter(@"C:\Users\victo\OneDrive\Documents\GitHub\Tech-Academy-Projects\Basic_C#_Programs\TwentyOne\TwentyOne\bin\Debug\Logs\log.txt", true))
                {
